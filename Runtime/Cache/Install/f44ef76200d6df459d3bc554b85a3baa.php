        ...
        <input type="hidden" name="step" value="2">
            ...
            <dl>
                ...
                <?php if(is_array($env)): $i = 0; $__LIST__ = $env;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li>
                    <b><?php echo ($item[0]); ?></b><span><?php echo ($item[1]); ?></span><span><?php echo ($item[3]); ?></span><span class="green"><?php if ($item[4] == 'success') { echo '√'; } else { echo '<font color="red">X检测未通过</font>'; } ?></if></span>       
            ...
            <dl>
                ...
                <?php if(is_array($func)): $i = 0; $__LIST__ = $func;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li>
                    <b><?php echo ($item[0]); ?></b><span><?php echo ($item[3]); ?></span><span><?php echo ($item[1]); ?></span><span class="green"><?php if ($item[2] == 'success') { echo '√'; } else { echo '<font color="red">X检测未通过</font>'; } ?></if></span>       
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <dl>
                ...
                <?php if(is_array($dirfile)): $i = 0; $__LIST__ = $dirfile;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li>
                    <b><?php echo ($item[3]); ?></b><span></span><span><?php echo ($item[1]); ?></span><span class="green"><?php if ($item[2] == 'success') { echo '√'; } else { echo '<font color="red">X检测未通过</font>'; } ?></if></span>       
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                
            </ul>
            <a class="btn btn-success pull-right" href="<?php echo U('Install/Install/step2');?>">下一步</a>
             </form>
        </div>
