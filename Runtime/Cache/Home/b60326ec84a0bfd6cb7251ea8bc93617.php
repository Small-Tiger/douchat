    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" role="navigation">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="http://doc.douchat.net/" target="_blank">手册</a>
          </li>
          <li class="hidden-sm hidden-md">
            <a href="http://bbs.douchat.net/" target="_blank">社区</a>
          </li>
        </ul>
...
<div class="jumbotron masthead">
  ...
  <div class="bc-social">
    <div class="container">
      <ul class="bc-social-buttons">
        <li class="social-qq">
          <i class="fa fa-qq"></i> 加入豆信交流群，感受集体的力量：<span id="qqgroup"><a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=41a33c33d92f00d63db24ae1490df68ade624d22488dfa8a832089fb8bbce576"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="豆信开源框架交流群" title="豆信开源框架交流群"></a></span>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="container projects">
      ...
      <div class="projects-header page-header">
        <h2>豆信功能概览</h2>
        <p>豆信自主研发了一套扩展性强的插件机制，对微信接口进行了高度封装。</p>
      </div>
      ...
      <div class="container">
        <div class="row footer-bottom">
          <ul class="list-inline text-center">
            <li><?php if($system_settings['site_copyright']): echo ($system_settings["site_copyright"]); else: ?>Copyright © 2015-2018 <a href="http://douchat.net/" target="_blank">豆信</a>版权所有<?php endif; ?></li><li><?php echo ($system_settings["site_icp_beian"]); ?></li>
          </ul>
        </div>
      </div>
    </footer>
