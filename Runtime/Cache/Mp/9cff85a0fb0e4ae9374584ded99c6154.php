                ...
                <table class="table table-striped">
	                <tbody>
	                	<tr>
		                    <td>
		                        <div class="form-group">
		                            <span class="col-sm-4 col-xs-3 control-label">账号名称:</span>
						...
						<tr>
							<td>
								<div class="form-group">
									<span class="col-sm-4 col-xs-3 control-label">账号类型:</span>
									<div class="col-sm-6 col-xs-8">
										<?php echo ($info["mp_type_name"]); ?>
									</div>
								</div>
							</td>
						</tr>
						<?php if($info['mp_type'] == 1): ?><tr>
		                    <td>
		                        <div class="form-group">
